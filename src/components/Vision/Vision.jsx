    ...
    <div className="vision-container">
        ...
        <div className="vision-content">
            ...
            <div className="description">
                Our vision is based on God's word, the bible:  So, go and make all nations my disciples by baptizing them in the name of the Father and the Son and the Holy Spirit and teaching them to abide by all that I have instructed you. Matthew 28: 19-20
            </div>
